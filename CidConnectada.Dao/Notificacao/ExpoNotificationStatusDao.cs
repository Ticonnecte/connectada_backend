...
{
    public class ExpoNotificationStatusDao : BaseDao<ExpoNotificationStatus, int, int, string>
    {
        public ExpoNotificationStatusDao(Func<ContextRequest<int, string>> contextFactory) : base(contextFactory)
        {
        }
        ...
        public override string[] DefaultIncludes
        {
            get => new string[2]
            {
                "Notification", "ExpoNotificationToken"
            };
        }
    }
}